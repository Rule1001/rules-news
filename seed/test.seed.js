...
function saveArticles() {
  const articles = [
    { title: 'Dogs are great', body: 'something', belongs_to: 'dogs' },
...
function saveComments(articles) {
  const comments = [
    { body: 'this is a comment', belongs_to: articles[0]._id, created_by: 'rule1001' },
    { body: 'this is another comment', belongs_to: articles[0]._id, created_by: 'rule1001' }
